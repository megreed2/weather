$(function() {
  var handleWeatherResponse = function(data) {
    ...
    // var data.summary.time.currently
    // Put your code here. Don't change any other code in this file. You will be sad.
    var markup = "Today: " + data.currently.summary + "." + " Tomorrow: " + data.daily.data[0].summary + " In 2 Days: " + data.daily.data[1].summary + " In 3 Days: " + data.daily.data[2].summary;
